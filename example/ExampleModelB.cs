...
[CreateAssetMenu(fileName = "ExampleModelB", menuName = "Switchboard/Examples/Example Model B", order = SwitchboardMenuOrder.Value)]
public sealed class ExampleModelB : ExampleModelBase
{
